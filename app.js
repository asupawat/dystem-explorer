...
if (settings.heavy != true) {
  bitcoinapi.setAccess('only', ['getinfo', 'getnetworkhashps', 'getmininginfo','getdifficulty', 'getconnectioncount',
    'getblockcount', 'getblockhash', 'getblock', 'getrawtransaction', 'getpeerinfo', 'gettxoutsetinfo', 'listmasternodes', 'getmasternodecount']);
} else {
  ...
  */
  bitcoinapi.setAccess('only', ['getinfo', 'getstakinginfo', 'getnetworkhashps', 'getdifficulty', 'getconnectioncount',
    ...
    'getnextrewardwhensec', 'getsupply', 'gettxoutsetinfo', 'listmasternodes', 'getmasternodecount']);
}
// view engine setup
